        ...
        private static void Main(string[] args)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var web3Interface = new NetworkInterface.Web3Interface(Config.web3api, Config.contractAddress, Config.minerAddress, Config.NFT_To_mint, Config.ERC20Addresses_To_mint, Config.maxAnswersPerSubmit, Config.minSecondsPerAnswer, Config.maxUSDperToken, Config.privateKey, Config.Difficulty_Multiplier, Config.chainID, WhatAddressToMineTo, Config.gasPrice,
                                                                          Config.abiFile, Config.networkUpdateInterval, Config.hashrateUpdateInterval,
                                                                          Config.gasLimit, Config.gasPricePriority, Config.gasApiURL, Config.gasApiPath, Config.gasApiMultiplier, Config.MaxSolvesperMint, Config.MinSolvesperMint, Config.HowManyBlocksAWAYFromAdjustmentToSendMinimumBWORK, Config.gasApiOffset, Config.gasApiMax, Config.mintToAddress, Config.CheckMinAmountIntervalInSeconds);
