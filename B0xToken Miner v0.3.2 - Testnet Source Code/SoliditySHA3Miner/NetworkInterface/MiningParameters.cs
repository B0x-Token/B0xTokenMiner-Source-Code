...
public class Result : IFunctionOutputDTO
{
    ...
    public byte[] ReturnData { get; set; }
        ...
        public HexBigInteger epochToReadjustment { get; private set; }
    ...
    int multiplier)
{
    ...
    var getChallengeNumberMethodId  = Convert.FromHexString("4ef37628");
       var epochToReadjustmentMethodID = Convert.FromHexString("34d5b131");
            ...
            var contractAddress = getMiningDifficulty.ContractAddress;
                ...
                var calls = new List<Call3>
                {
                    ...
                    new Call3
                    {
                        Target = contractAddress,
                        AllowFailure = true,
                        CallData = epochToReadjustmentMethodID
                    }
                };
...
var challengeResult = multicallResult[2];
                    ...
                    var epochToReadjustmentResult = multicallResult[3];
            ...
            var epochToReadjustmentSuccess  = epochToReadjustmentResult.Success;
            ...
            Program.Print($"[MULTICALL RESULTS] epochToReadjustment Success: {epochToReadjustmentSuccess}");
...
epochToReadjustment = new HexBigInteger(ConvertToBigInteger(epochToReadjustmentResult.ReturnData));
